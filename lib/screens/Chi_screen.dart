...
class ChiScreen extends StatefulWidget {
  final Chi chi;
  const ChiScreen({Key? key, required this.chi}) : super(key: key);
        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              Container(
                ...
                child: Hero(
                  tag: widget.chi.imageUrl,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(30.0),
                    child: Image(
                      image: AssetImage(widget.chi.imageUrl),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: widget.chi.activities.length,
              itemBuilder: (BuildContext context, int index) {
                Activity activity = widget.chi.activities[index];
                return Stack(
                  children: <Widget>[
                    Container(
